...
------------ | ------------- | ------------- | -------------
**id** | **String** | the Id of the form. We encourage using either a v4 UUID or a HL7 Id. |
**rev** | **String** | the revision of the form in the database, used for conflict management / optimistic locking. | [optional]
...
**openingDate** | **int** |  | [optional]
**status** | **String** |  | [optional]
**version** | **int** |  | [optional]
**logicalUuid** | **String** |  | [optional]
**descr** | **String** | Name/basic description of the form | [optional]
**uniqueId** | **String** | A unique external id (from another external source). | [optional]
**formTemplateId** | **String** | Id of the form template being used to display the form | [optional]
**contactId** | **String** | Id of the contact for which the form is being used. | [optional]
**healthElementId** | **String** | The healthcare element to which this form is attached. | [optional]
**planOfActionId** | **String** | The healthcare approach to which this form is attached. | [optional]
**parent** | **String** | The parent of this form, used to determine the forms hierarchy | [optional]
