# icure_dart_sdk.model.AccessLogDto
...
------------ | ------------- | ------------- | -------------
**id** | **String** | The Id of the Access log. We encourage using either a v4 UUID or a HL7 Id | 
**rev** | **String** | The revision of the access log in the database, used for conflict management / optimistic locking. | [optional] 
...
**objectId** | **String** | Id of the object that is being requested. | [optional] 
**accessType** | **String** | The type of access | [optional] 
**user** | **String** | Id of the user making the requests | [optional] 
**detail** | **String** | Further details about the access | [optional] 
**date** | [**DateTime**](DateTime.md) | The date (unix epoch in ms) of logging, is filled instantaneously. | [optional] 
