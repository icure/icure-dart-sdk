...
class PaginatedListString {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaginatedListString &&
  ...
  static List<PaginatedListString> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PaginatedListString.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PaginatedListString>[];
  ...
  static Map<String, PaginatedListString> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PaginatedListString.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PaginatedListString-objects as value to a dart map
  static Map<String, List<PaginatedListString>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PaginatedListString>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PaginatedListString.listFromJson(
            value,
