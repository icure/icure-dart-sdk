...
class SubstanceStubDto {
  ...
  static List<SubstanceStubDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SubstanceStubDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubstanceStubDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
