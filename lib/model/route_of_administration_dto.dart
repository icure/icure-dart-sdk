...
class RouteOfAdministrationDto {
  ...
  // ignore: unnecessary_parenthesis
    ...
    (standardRoutes == null ? 0 : standardRoutes.hashCode);
  ...
  static List<RouteOfAdministrationDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(RouteOfAdministrationDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <RouteOfAdministrationDto>[];
  ...
  static Map<String, RouteOfAdministrationDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = RouteOfAdministrationDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of RouteOfAdministrationDto-objects as value to a dart map
  static Map<String, List<RouteOfAdministrationDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<RouteOfAdministrationDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = RouteOfAdministrationDto.listFromJson(
            value,
