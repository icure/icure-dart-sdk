...
class TimeTableDto {
  ...
  // ignore: unnecessary_parenthesis
    ...
    (publicTimeTable == null ? 0 : publicTimeTable.hashCode) +
  ...
  /// Returns a new [TimeTableDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TimeTableDto fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<TimeTableDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(TimeTableDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <TimeTableDto>[];

  static Map<String, TimeTableDto> mapFromJson(dynamic json) {
    final map = <String, TimeTableDto>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = TimeTableDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of TimeTableDto-objects as value to a dart map
  static Map<String, List<TimeTableDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<TimeTableDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = TimeTableDto.listFromJson(
            value,
