...
class SubContactDto {
  ...
  static List<SubContactDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(SubContactDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <SubContactDto>[];
  ...
  static Map<String, SubContactDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = SubContactDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SubContactDto-objects as value to a dart map
  static Map<String, List<SubContactDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<SubContactDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = SubContactDto.listFromJson(
            value,
