...
class PaginatedListHealthElementDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is PaginatedListHealthElementDto &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaginatedListHealthElementDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaginatedListHealthElementDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PaginatedListHealthElementDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaginatedListHealthElementDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaginatedListHealthElementDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaginatedListHealthElementDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PaginatedListHealthElementDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<PaginatedListHealthElementDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaginatedListHealthElementDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaginatedListHealthElementDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
