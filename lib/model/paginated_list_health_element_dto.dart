...
class PaginatedListHealthElementDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is PaginatedListHealthElementDto &&
  ...
  static PaginatedListHealthElementDto? fromJson(dynamic value) {
    if (value is PaginatedListHealthElementDto) {
      return value;
    }
    if (value is Map) {
  ...
  static List<PaginatedListHealthElementDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PaginatedListHealthElementDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaginatedListHealthElementDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
