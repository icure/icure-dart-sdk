...
class IcureStubDto {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IcureStubDto &&
     other.id == id &&
     other.rev == rev &&
  ...
  @override
  String toString() => 'IcureStubDto[id=$id, rev=$rev, created=$created, modified=$modified, author=$author, responsible=$responsible, medicalLocationId=$medicalLocationId, tags=$tags, codes=$codes, endOfLife=$endOfLife, secretForeignKeys=$secretForeignKeys, cryptedForeignKeys=$cryptedForeignKeys, delegations=$delegations, encryptionKeys=$encryptionKeys, encryptedSelf=$encryptedSelf]';
  ...
  /// Returns a new [IcureStubDto] instance and imports its values from
  ...
  static List<IcureStubDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(IcureStubDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <IcureStubDto>[];

  static Map<String, IcureStubDto> mapFromJson(dynamic json) {
    final map = <String, IcureStubDto>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = IcureStubDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of IcureStubDto-objects as value to a dart map
  static Map<String, List<IcureStubDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<IcureStubDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = IcureStubDto.listFromJson(
            value,
