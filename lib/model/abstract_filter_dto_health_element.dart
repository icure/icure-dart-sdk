...
class AbstractFilterDtoHealthElement {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AbstractFilterDtoHealthElement &&
     other.desc == desc;
  ...
  static List<AbstractFilterDtoHealthElement> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(AbstractFilterDtoHealthElement.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <AbstractFilterDtoHealthElement>[];
  ...
  static Map<String, AbstractFilterDtoHealthElement> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = AbstractFilterDtoHealthElement.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AbstractFilterDtoHealthElement-objects as value to a dart map
  static Map<String, List<AbstractFilterDtoHealthElement>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<AbstractFilterDtoHealthElement>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = AbstractFilterDtoHealthElement.listFromJson(
            value,
