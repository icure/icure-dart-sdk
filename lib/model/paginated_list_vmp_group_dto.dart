...
class PaginatedListVmpGroupDto {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaginatedListVmpGroupDto &&
  ...
  static List<PaginatedListVmpGroupDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PaginatedListVmpGroupDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PaginatedListVmpGroupDto>[];
  ...
  static Map<String, PaginatedListVmpGroupDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PaginatedListVmpGroupDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PaginatedListVmpGroupDto-objects as value to a dart map
  static Map<String, List<PaginatedListVmpGroupDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PaginatedListVmpGroupDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PaginatedListVmpGroupDto.listFromJson(
            value,
