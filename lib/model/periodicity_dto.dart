...
class PeriodicityDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is PeriodicityDto && other.relatedCode == relatedCode && other.relatedPeriodicity == relatedPeriodicity;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (relatedCode == null ? 0 : relatedCode!.hashCode) + (relatedPeriodicity == null ? 0 : relatedPeriodicity!.hashCode);
  ...
  static List<PeriodicityDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PeriodicityDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PeriodicityDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
