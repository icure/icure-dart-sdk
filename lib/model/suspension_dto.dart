...
class SuspensionDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is SuspensionDto && other.beginMoment == beginMoment && other.endMoment == endMoment && other.suspensionReason == suspensionReason;
  ...
  static List<SuspensionDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SuspensionDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SuspensionDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
