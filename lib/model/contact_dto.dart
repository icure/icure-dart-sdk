...
class ContactDto {
  ...
  static List<ContactDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ContactDto.fromJson).toList(growable: true == growable)
  ...
  static Map<String, ContactDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ContactDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ContactDto-objects as value to a dart map
  static Map<String, List<ContactDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ContactDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ContactDto.listFromJson(
            value,
