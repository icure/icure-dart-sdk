...
class DocIdentifier {
  ...
  static List<DocIdentifier>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DocIdentifier>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DocIdentifier>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DocIdentifier.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
