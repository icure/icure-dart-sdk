...
class TelecomDto {
  ...
  static List<TelecomDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(TelecomDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <TelecomDto>[];
  ...
  static Map<String, TelecomDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = TelecomDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of TelecomDto-objects as value to a dart map
  static Map<String, List<TelecomDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<TelecomDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = TelecomDto.listFromJson(
            value,
...
class TelecomDtoTelecomTypeEnum {
  ...
  static TelecomDtoTelecomTypeEnum fromJson(dynamic value) =>
    TelecomDtoTelecomTypeEnumTypeTransformer().decode(value);

  static List<TelecomDtoTelecomTypeEnum> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(TelecomDtoTelecomTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <TelecomDtoTelecomTypeEnum>[];
}
...
class TelecomDtoTelecomTypeEnumTypeTransformer {
  ...
  TelecomDtoTelecomTypeEnum decode(dynamic data, {bool allowNull}) {
    if (data != null) {
