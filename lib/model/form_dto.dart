...
class FormDto {
  ...
  static List<FormDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(FormDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <FormDto>[];
  ...
  static Map<String, FormDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = FormDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of FormDto-objects as value to a dart map
  static Map<String, List<FormDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<FormDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = FormDto.listFromJson(
            value,
