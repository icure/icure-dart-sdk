...
class Formula {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Formula && other.value == value && other.lifecycle == lifecycle;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (value == null ? 0 : value!.hashCode) + (lifecycle == null ? 0 : lifecycle!.hashCode);
  ...
  static List<Formula>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Formula>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Formula.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
...
class FormulaLifecycleEnum {
  ...
  static List<FormulaLifecycleEnum>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
