...
class PaginatedListInvoiceDto {
  ...
  static List<PaginatedListInvoiceDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PaginatedListInvoiceDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PaginatedListInvoiceDto>[];
  ...
  static Map<String, PaginatedListInvoiceDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PaginatedListInvoiceDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PaginatedListInvoiceDto-objects as value to a dart map
  static Map<String, List<PaginatedListInvoiceDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PaginatedListInvoiceDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PaginatedListInvoiceDto.listFromJson(
            value,
