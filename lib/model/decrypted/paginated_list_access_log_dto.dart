...
class DecryptedPaginatedListAccessLogDto {
  /// Returns a new [DecryptedPaginatedListAccessLogDto] instance.
  DecryptedPaginatedListAccessLogDto({
  ...
  @override
  String toString() => 'DecryptedPaginatedListAccessLogDto[pageSize=$pageSize, totalSize=$totalSize, rows=$rows, nextKeyPair=$nextKeyPair]';
  ...
  /// Returns a new [DecryptedPaginatedListAccessLogDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DecryptedPaginatedListAccessLogDto? fromJson(dynamic value) {
    if (value is DecryptedPaginatedListAccessLogDto) {
      return value;
    }
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DecryptedPaginatedListAccessLogDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DecryptedPaginatedListAccessLogDto[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DecryptedPaginatedListAccessLogDto(
  ...
  static List<DecryptedPaginatedListAccessLogDto>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DecryptedPaginatedListAccessLogDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DecryptedPaginatedListAccessLogDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = DecryptedPaginatedListAccessLogDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<DecryptedPaginatedListAccessLogDto>> mapListFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DecryptedPaginatedListAccessLogDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
