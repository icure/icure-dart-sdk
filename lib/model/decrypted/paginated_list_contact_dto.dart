...
class DecryptedPaginatedListContactDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is DecryptedPaginatedListContactDto &&
  ...
  /// Returns a new [DecryptedPaginatedListContactDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DecryptedPaginatedListContactDto? fromJson(dynamic value) {
    if (value is DecryptedPaginatedListContactDto) {
      return value;
    }
    if (value is Map) {
  ...
  static List<DecryptedPaginatedListContactDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <DecryptedPaginatedListContactDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DecryptedPaginatedListContactDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DecryptedPaginatedListContactDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = DecryptedPaginatedListContactDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DecryptedPaginatedListContactDto-objects as value to a dart map
  static Map<String, List<DecryptedPaginatedListContactDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<DecryptedPaginatedListContactDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DecryptedPaginatedListContactDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
