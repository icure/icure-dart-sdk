...
class IdentifierDto {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IdentifierDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IdentifierDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IdentifierDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IdentifierDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IdentifierDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IdentifierDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = IdentifierDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IdentifierDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IdentifierDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IdentifierDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
