...
class AbstractFilterDtoHealthcareParty {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AbstractFilterDtoHealthcareParty[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AbstractFilterDtoHealthcareParty[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AbstractFilterDtoHealthcareParty>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AbstractFilterDtoHealthcareParty>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AbstractFilterDtoHealthcareParty.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AbstractFilterDtoHealthcareParty> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = AbstractFilterDtoHealthcareParty.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<AbstractFilterDtoHealthcareParty>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AbstractFilterDtoHealthcareParty>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AbstractFilterDtoHealthcareParty.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
