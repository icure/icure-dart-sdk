...
class ClassificationDto {
  ...
  static List<ClassificationDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ClassificationDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ClassificationDto>[];
  ...
  static Map<String, ClassificationDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ClassificationDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ClassificationDto-objects as value to a dart map
  static Map<String, List<ClassificationDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ClassificationDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ClassificationDto.listFromJson(
            value,
