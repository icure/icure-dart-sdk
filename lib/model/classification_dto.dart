...
class ClassificationDto {
  /// Returns a new [ClassificationDto] instance.
  ClassificationDto({
    required this.id,
    this.rev,
    this.created,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ClassificationDto &&
     other.id == id &&
     other.rev == rev &&
  ...
  /// Returns a new [ClassificationDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClassificationDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClassificationDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClassificationDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ClassificationDto>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ClassificationDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClassificationDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClassificationDto> mapFromJson(dynamic json) {
    final map = <String, ClassificationDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClassificationDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ClassificationDto-objects as value to a dart map
  static Map<String, List<ClassificationDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ClassificationDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClassificationDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
