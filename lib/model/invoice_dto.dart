...
class InvoiceDto {
  ...
  static InvoiceDto fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InvoiceDto(
        ...
        payments: PaymentDto.listFromJson(json[r'payments']),
  ...
  static List<InvoiceDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InvoiceDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InvoiceDto>[];
  ...
  static Map<String, InvoiceDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = InvoiceDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of InvoiceDto-objects as value to a dart map
  static Map<String, List<InvoiceDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<InvoiceDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = InvoiceDto.listFromJson(
            value,
...
class InvoiceDtoInvoiceTypeEnum {
  ...
  static InvoiceDtoInvoiceTypeEnum fromJson(dynamic value) =>
    InvoiceDtoInvoiceTypeEnumTypeTransformer().decode(value);

  static List<InvoiceDtoInvoiceTypeEnum> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InvoiceDtoInvoiceTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InvoiceDtoInvoiceTypeEnum>[];
}
...
class InvoiceDtoInvoiceTypeEnumTypeTransformer {
  ...
  InvoiceDtoInvoiceTypeEnum decode(dynamic data, {bool allowNull}) {
    if (data != null) {
...
class InvoiceDtoSentMediumTypeEnum {
  ...
  static InvoiceDtoSentMediumTypeEnum fromJson(dynamic value) =>
    InvoiceDtoSentMediumTypeEnumTypeTransformer().decode(value);

  static List<InvoiceDtoSentMediumTypeEnum> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InvoiceDtoSentMediumTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InvoiceDtoSentMediumTypeEnum>[];
}
...
class InvoiceDtoSentMediumTypeEnumTypeTransformer {
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDtoSentMediumTypeEnum decode(dynamic data, {bool allowNull}) {
    if (data != null) {
      switch (data.toString()) {
...
class InvoiceDtoInterventionTypeEnum {
  ...
  static InvoiceDtoInterventionTypeEnum fromJson(dynamic value) =>
    InvoiceDtoInterventionTypeEnumTypeTransformer().decode(value);

  static List<InvoiceDtoInterventionTypeEnum> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InvoiceDtoInterventionTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InvoiceDtoInterventionTypeEnum>[];
}
...
class InvoiceDtoInterventionTypeEnumTypeTransformer {
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDtoInterventionTypeEnum decode(dynamic data, {bool allowNull}) {
    if (data != null) {
      switch (data.toString()) {
...
class InvoiceDtoPaymentTypeEnum {
  ...
  static InvoiceDtoPaymentTypeEnum fromJson(dynamic value) =>
    InvoiceDtoPaymentTypeEnumTypeTransformer().decode(value);

  static List<InvoiceDtoPaymentTypeEnum> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(InvoiceDtoPaymentTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <InvoiceDtoPaymentTypeEnum>[];
}
...
class InvoiceDtoPaymentTypeEnumTypeTransformer {
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDtoPaymentTypeEnum decode(dynamic data, {bool allowNull}) {
    if (data != null) {
      switch (data.toString()) {
