...
class PaginatedListDocumentDto {
  ...
  static List<PaginatedListDocumentDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PaginatedListDocumentDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PaginatedListDocumentDto>[];
  ...
  static Map<String, PaginatedListDocumentDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PaginatedListDocumentDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PaginatedListDocumentDto-objects as value to a dart map
  static Map<String, List<PaginatedListDocumentDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PaginatedListDocumentDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PaginatedListDocumentDto.listFromJson(
            value,
