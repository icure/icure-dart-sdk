...
class SubstanceproductDto {
  ...
  static List<SubstanceproductDto> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(SubstanceproductDto.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <SubstanceproductDto>[];
  ...
  static Map<String, SubstanceproductDto> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = SubstanceproductDto.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SubstanceproductDto-objects as value to a dart map
  static Map<String, List<SubstanceproductDto>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<SubstanceproductDto>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = SubstanceproductDto.listFromJson(
            value,
