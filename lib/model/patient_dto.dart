...
/// the gender of the patient: male, female, indeterminate, changed, changedToMale, changedToFemale, unknown
class PatientDtoGenderEnum {
  /// Instantiate a new enum with the provided [value].
  const PatientDtoGenderEnum._(this.value);
  ...
  static const male = PatientDtoGenderEnum._(r'male');
  static const female = PatientDtoGenderEnum._(r'female');
  static const indeterminate = PatientDtoGenderEnum._(r'indeterminate');
  static const changed = PatientDtoGenderEnum._(r'changed');
  static const changedToMale = PatientDtoGenderEnum._(r'changedToMale');
  static const changedToFemale = PatientDtoGenderEnum._(r'changedToFemale');
  static const unknown = PatientDtoGenderEnum._(r'unknown');

  /// List of all possible values in this [enum][PatientDtoGenderEnum].
  static const values = <PatientDtoGenderEnum>[
    male,
    female,
    indeterminate,
    changed,
...
/// and [decode] dynamic data back to [PatientDtoGenderEnum].
class PatientDtoGenderEnumTypeTransformer {
  factory PatientDtoGenderEnumTypeTransformer() => _instance ??= const PatientDtoGenderEnumTypeTransformer._();

  const PatientDtoGenderEnumTypeTransformer._();

  String encode(PatientDtoGenderEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PatientDtoGenderEnum.
  ///
...
class PatientDtoBirthSexEnum {
  /// Instantiate a new enum with the provided [value].
  const PatientDtoBirthSexEnum._(this.value);
  ...
  static const male = PatientDtoBirthSexEnum._(r'male');
  static const female = PatientDtoBirthSexEnum._(r'female');
  static const indeterminate = PatientDtoBirthSexEnum._(r'indeterminate');
  static const changed = PatientDtoBirthSexEnum._(r'changed');
  static const changedToMale = PatientDtoBirthSexEnum._(r'changedToMale');
  static const changedToFemale = PatientDtoBirthSexEnum._(r'changedToFemale');
  static const unknown = PatientDtoBirthSexEnum._(r'unknown');

  /// List of all possible values in this [enum][PatientDtoBirthSexEnum].
...
/// and [decode] dynamic data back to [PatientDtoBirthSexEnum].
class PatientDtoBirthSexEnumTypeTransformer {
  factory PatientDtoBirthSexEnumTypeTransformer() => _instance ??= const PatientDtoBirthSexEnumTypeTransformer._();

  const PatientDtoBirthSexEnumTypeTransformer._();

  String encode(PatientDtoBirthSexEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PatientDtoBirthSexEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
...
class PatientDtoDeactivationReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const PatientDtoDeactivationReasonEnum._(this.value);
  ...
  static const deceased = PatientDtoDeactivationReasonEnum._(r'deceased');
  static const moved = PatientDtoDeactivationReasonEnum._(r'moved');
  static const otherDoctor = PatientDtoDeactivationReasonEnum._(r'other_doctor');
  static const retired = PatientDtoDeactivationReasonEnum._(r'retired');
  static const noContact = PatientDtoDeactivationReasonEnum._(r'no_contact');
  static const unknown = PatientDtoDeactivationReasonEnum._(r'unknown');
  static const none = PatientDtoDeactivationReasonEnum._(r'none');

  /// List of all possible values in this [enum][PatientDtoDeactivationReasonEnum].
...
/// and [decode] dynamic data back to [PatientDtoDeactivationReasonEnum].
class PatientDtoDeactivationReasonEnumTypeTransformer {
  factory PatientDtoDeactivationReasonEnumTypeTransformer() => _instance ??= const PatientDtoDeactivationReasonEnumTypeTransformer._();

  const PatientDtoDeactivationReasonEnumTypeTransformer._();

  String encode(PatientDtoDeactivationReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PatientDtoDeactivationReasonEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
...
class PatientDtoPersonalStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const PatientDtoPersonalStatusEnum._(this.value);
  ...
  static const single = PatientDtoPersonalStatusEnum._(r'single');
  static const inCouple = PatientDtoPersonalStatusEnum._(r'in_couple');
  static const married = PatientDtoPersonalStatusEnum._(r'married');
  static const separated = PatientDtoPersonalStatusEnum._(r'separated');
  static const divorced = PatientDtoPersonalStatusEnum._(r'divorced');
  static const divorcing = PatientDtoPersonalStatusEnum._(r'divorcing');
  static const widowed = PatientDtoPersonalStatusEnum._(r'widowed');
  static const widower = PatientDtoPersonalStatusEnum._(r'widower');
  static const complicated = PatientDtoPersonalStatusEnum._(r'complicated');
  static const unknown = PatientDtoPersonalStatusEnum._(r'unknown');
  static const contract = PatientDtoPersonalStatusEnum._(r'contract');
  static const other = PatientDtoPersonalStatusEnum._(r'other');
  static const annulled = PatientDtoPersonalStatusEnum._(r'annulled');
  static const polygamous = PatientDtoPersonalStatusEnum._(r'polygamous');

  /// List of all possible values in this [enum][PatientDtoPersonalStatusEnum].
  static const values = <PatientDtoPersonalStatusEnum>[
    single,
    inCouple,
    married,
    separated,
...
/// and [decode] dynamic data back to [PatientDtoPersonalStatusEnum].
class PatientDtoPersonalStatusEnumTypeTransformer {
  factory PatientDtoPersonalStatusEnumTypeTransformer() => _instance ??= const PatientDtoPersonalStatusEnumTypeTransformer._();

  const PatientDtoPersonalStatusEnumTypeTransformer._();

  String encode(PatientDtoPersonalStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PatientDtoPersonalStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
