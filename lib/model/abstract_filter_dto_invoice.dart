...
class AbstractFilterDtoInvoice {
  ...
  static List<AbstractFilterDtoInvoice> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(AbstractFilterDtoInvoice.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <AbstractFilterDtoInvoice>[];
  ...
  static Map<String, AbstractFilterDtoInvoice> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = AbstractFilterDtoInvoice.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AbstractFilterDtoInvoice-objects as value to a dart map
  static Map<String, List<AbstractFilterDtoInvoice>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<AbstractFilterDtoInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = AbstractFilterDtoInvoice.listFromJson(
            value,
