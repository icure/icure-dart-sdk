...
class PaginatedListUserDto {
  ...
  static PaginatedListUserDto? fromJson(dynamic value) {
    if (value is PaginatedListUserDto) {
      return value;
    }
    if (value is Map) {
  ...
  static List<PaginatedListUserDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PaginatedListUserDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaginatedListUserDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
