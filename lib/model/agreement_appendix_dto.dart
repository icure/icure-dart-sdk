...
class AgreementAppendixDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is AgreementAppendixDto && other.docSeq == docSeq && other.verseSeq == verseSeq && other.documentId == documentId && other.path == path;
  ...
  static AgreementAppendixDto? fromJson(dynamic value) {
    if (value is AgreementAppendixDto) {
      return value;
    }
    if (value is Map) {
  ...
  static List<AgreementAppendixDto>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AgreementAppendixDto>> mapListFromJson(dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AgreementAppendixDto.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
