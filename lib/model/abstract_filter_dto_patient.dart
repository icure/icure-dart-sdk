...
class AbstractFilterDtoPatient {
  ...
  static List<AbstractFilterDtoPatient> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(AbstractFilterDtoPatient.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <AbstractFilterDtoPatient>[];
  ...
  static Map<String, AbstractFilterDtoPatient> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = AbstractFilterDtoPatient.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AbstractFilterDtoPatient-objects as value to a dart map
  static Map<String, List<AbstractFilterDtoPatient>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<AbstractFilterDtoPatient>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = AbstractFilterDtoPatient.listFromJson(
            value,
