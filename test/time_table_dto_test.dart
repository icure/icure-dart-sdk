...
// tests for TimeTableDto
void main() {
  final instance = TimeTableDto();

  group('test TimeTableDto', () {
    // String id
    ...
    test('to test the property `publicTimeTable`', () async {
      // TODO
    });
    ...
    // List<TimeTableItemDto> items (default value: const [])
