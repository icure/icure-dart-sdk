...
// tests for KeywordDto
void main() {
  final instance = KeywordDto();

  group('test KeywordDto', () {
    // String id
    ...
    // Set<KeywordSubwordDto> subWords (default value: const {})
    test('to test the property `subWords`', () async {
      // TODO
    });
