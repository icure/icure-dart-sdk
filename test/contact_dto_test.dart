...
void main() {
  ...
  group('test ContactDto', () {
    ...
    test('to test the property `encounterType`', () async {
      // TODO
    });
    ...
    // Set<SubContactDto> subContacts (default value: const {})
    test('to test the property `subContacts`', () async {
      // TODO
    });

    // Set of all services provided to the patient during the contact.
    // Set<ServiceDto> services (default value: const {})
    ...
    test('to test the property `modifiedContactId`', () async {
      // TODO
    });
